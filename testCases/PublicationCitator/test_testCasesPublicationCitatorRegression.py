...
class Test_testCasesPublicationCitatorRegression(softest.TestCase):
    ...
    def test_metaDataLinks(self):
        ...
        for handle in all_handles:
            if handle != parent_handle:
                ...
                time.sleep(2)
                getext = self.driver.find_element(By.LINK_TEXT, "Publication Citator")
                text = getext.text
    ...
    def test_copyCitation(self):
        ...
        self.logger.info("*****Login Successful****")
        self.logger.info("**** Publicatiom Citator testing *****")
        self.navigator = PublicationCitator(self.driver)
        self.navigator.clickOnPublicationCitator()
        time.sleep(2)
        # self.navigator.clickOnClientListing()
   ...
   ####----New Addition###
    ...
    @pytest.mark.skip(reason="None")
    def test_BooksMenuAddtoNotepad(self):
        self.logger.info("****TestCase AC-018 - Verify Books Menu - Add to Notepad***")
        self.logger.info("*****Login Successful****")
        self.logger.info("**** Publication Citator testing *****")
        self.navigator = PublicationCitator(self.driver)
        self.navigator.clickOnPublicationCitator()
        time.sleep(2)
        self.logger.info("Clicked on Publication Citator")
        self.navigator.clickOnBooksSubMenu()
        time.sleep(2)
        self.logger.info("Clicked on Books Sub Menu")
        self.navigator.clickOnBooksFirstLink()
        time.sleep(2)
        self.logger.info("Clicked on Books -First Link")
        self.navigator.clickOnBooksActions()
        time.sleep(2)
        self.logger.info("Clicked on Actions")
        self.navigator.clickOnBooksAddToNotepad()
        time.sleep(2)
        self.logger.info("Clicked on Add To Notepad")
        self.navigator.selectBooksResearchOption()
        time.sleep(2)
        self.logger.info("Clicked on Add To Notepad")
        self.navigator.clickOnBooksResearchAdd()
        time.sleep(2)
        self.logger.info("Click on Research Add")
        self.navigator.selectBooksEntirePublictaion()
        time.sleep(2)
        self.logger.info("Selected entire publication")
        self.navigator.clickOnAddEntirePublication()
        time.sleep(2)
        self.logger.info("Clicked on Add Notepad - Added to research notepad")

    @pytest.mark.skip(reason="None")
    def test_BooksMenuCopyLocation(self):
        self.logger.info("****TestCase AC-019 - Verify Books Menu Copy Location***")
        self.logger.info("*****Login Successful****")
        self.logger.info("**** Publication Citator testing *****")
        self.navigator = PublicationCitator(self.driver)
        self.navigator.clickOnPublicationCitator()
        ...
        time.sleep(2)
        self.logger.info("Clicked on Actions")
        self.navigator.clickOnBooksCopyLocation()
        time.sleep(2)
        self.logger.info("Copied Location")

    @pytest.mark.skip(reason="None")
    def test_BooksMenuFollowTopic(self):
        self.logger.info("****TestCase AC-020 - Verify Books Follow Topic***")
        self.logger.info("*****Login Successful****")
        self.logger.info("**** Publication Citator testing *****")
        self.navigator = PublicationCitator(self.driver)
        self.navigator.clickOnPublicationCitator()
        ...
        time.sleep(2)
        self.logger.info("Clicked on Actions")
        self.navigator.clickOnBooksFollowTopic()
        time.sleep(2)
        self.logger.info("Clicked on Follow Topic")

    @pytest.mark.skip(reason="None")
    def test_dictionaryMenuAddToNotepad(self):
        self.logger.info("****TestCase AC-022 - Verify Dictionary - Add To Notepad***")
        self.logger.info("*****Login Successful****")
        self.logger.info("**** Publication Citator testing *****")
        self.navigator = PublicationCitator(self.driver)
        self.navigator.clickOnPublicationCitator()
        time.sleep(2)
        self.logger.info("Clicked on Publication Citator")
        self.navigator.clickOnDictionarySubMenu()
        time.sleep(2)
        self.logger.info("Clicked on Dictionary Sub menu")
        self.navigator.clickOnDictionaryFirstLink()
        time.sleep(2)
        self.logger.info("Clicked on Dictionary - First Link")
        self.navigator.clickOnDictionaryActions()
        time.sleep(2)
        self.logger.info("Clicked on Actions")
        self.navigator.clickOnDictionaryResearchNotepad()
        time.sleep(2)
        self.logger.info("Clicked on research Notepad")
        self.navigator.selectDictionaryResearchOption()
        time.sleep(2)
        self.logger.info("Selected Research Option")
        self.navigator.clickOnDictionaryResearchAdd()
        time.sleep(2)
        self.logger.info("Clicked on Dictionary Research Add")
        self.navigator.selectDictionaryEntirePublication()
        time.sleep(2)
        self.logger.info("Selected Entire Publication")
        self.navigator.clickOnDictionaryEntirePublicationAdd()
        time.sleep(2)
        self.logger.info("Dictionary -Added to Research Notepad")

    @pytest.mark.skip(reason="None")
    def test_dictionaryCopyLocation(self):
        self.logger.info("****TestCase AC-023 - Verify Dictionary - Copy Location***")
        self.logger.info("*****Login Successful****")
        self.logger.info("**** Publication Citator testing *****")
        self.navigator = PublicationCitator(self.driver)
        self.navigator.clickOnPublicationCitator()
        ...
        time.sleep(2)
        self.logger.info("Clicked on Actions")
        self.navigator.clickOnDictionaryCopyLocation()
        time.sleep(2)
        self.logger.info("Click on Copy location")

    @pytest.mark.skip(reason="None")
    def test_dictionaryFollowTopic(self):
        self.logger.info("****TestCase AC-024 - Verify Dictionary - Follow Topic***")
        self.logger.info("*****Login Successful****")
        self.logger.info("**** Publication Citator testing *****")
        self.navigator = PublicationCitator(self.driver)
        self.navigator.clickOnPublicationCitator()
        ...
        time.sleep(2)
        self.logger.info("Clicked on Actions")
        self.navigator.clickOnDictionaryFollowTopic()
        time.sleep(2)
        self.logger.info("Dictionary - Clicked on Follow Topic")

    #@pytest.mark.skip(reason="None")
    def test_newsOnlineSourceMenuAddToNotepad(self):
        self.logger.info("****TestCase AC-025 - Verify Dictionary - Add To Notepad***")
        self.logger.info("*****Login Successful****")
        self.logger.info("**** Publication Citator testing *****")
        self.navigator = PublicationCitator(self.driver)
        self.navigator.clickOnPublicationCitator()
