...
class Test_TermsAndPhrases:
    ...
    def test_addToResearchNotepad(self):
        ...
        time.sleep(2)
        addToResearch = self.driver.find_element(By.XPATH, "(//div[@class='card__actions dropdown']//div[1]//p//a)[1]")
        ...
        researchTopicOption1 = self.driver.find_element(By.XPATH, "//*[@id='TopicSelection']/ul/li[1]/label/span")
    ...
    def test_copyCitation(self):
        ...
        copyCitation = self.driver.find_element(By.XPATH, "(//div[@class='tabs__content-container']//div//div//div//p//a)[1]")
