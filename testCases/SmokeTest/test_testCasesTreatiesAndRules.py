...
class Test_Reports:
    ...
    def test_01SearchAndReset(self):
    ...
    def test_03ResearchNotepad(self):
        ...
        time.sleep(2)
        researchNote = self.driver.find_element(By.XPATH, "(//div[@class='tabs hide-compact']//div//div//div//p//a)[1]")
        self.driver.execute_script("arguments[0].click();", researchNote)
    ...
    #@pytest.mark.skip(reason="None")
    def test_07InstrumentDetailsCopyCitation(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_08DocumentComparison(self):
