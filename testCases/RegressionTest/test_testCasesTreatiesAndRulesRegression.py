...
class Test_Reports:
    ...
    def test_01downloadDocument(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_02addToDocumentComparison(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_03researchNotepad(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_05viewOriginialPDF(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_06InstrumentDetailsAddtoDocument(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_07instrumentDetailsResearchNotepad(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_08instrumnetDetailsdownloadDocument(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_09instrumentDetailsviewOriginialPDF(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_10instrumentDetailscopyCitation(self):
