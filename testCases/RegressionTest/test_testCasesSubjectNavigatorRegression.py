...
class Test_testCasesSubjectNavigatorRegression(softest.TestCase):
    ...
    def test_01crossReferences(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_02FullCaseAnalysis(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_03SubjectNavigatorLink(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_06downloadDocument(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_07documentComparison(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_08researchNotepad(self):
