...
class Test_testCasesJurisprudenceCitatorRegression(softest.TestCase):
    ...
    def test_02AdddocumentComparison(self):
        ...
        time.sleep(2)
        self.logger.info("Expanded inner card")
        #elf.navigator.clickOnSeeAllRef()
        seeAll = self.driver.find_element(By.XPATH, "//ul[@class='list--bordered list--bordered-no-padding']//li[2]//a")
        self.driver.execute_script("arguments[0].click();", seeAll)
        time.sleep(2)
        self.logger.info("Clicked on See All References Link")
        fullCase = self.driver.find_element(By.XPATH, "//a[@title='Full Case & Analysis']")
        self.driver.execute_script("arguments[0].scrollIntoView();", fullCase)
    ...
    #@pytest.mark.skip(reason="None")
    def test_14ArticleCitatorNavigation(self):
