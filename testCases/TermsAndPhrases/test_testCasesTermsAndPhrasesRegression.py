...
class Test_TermsAndPhrases:
    ...
    #@pytest.mark.skip(reason="None")
    def test_ViewInTermsAndPhrases(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_AllDisputesDocuments(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_downloadAllDocuments(self):
    ...
    #@pytest.mark.skip(reason="None")
    def test_viewParagraphExcerpt(self):
        self.logger.info(
